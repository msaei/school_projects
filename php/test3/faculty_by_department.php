...
$select_clause = "SELECT f.faculty_id AS faculty_id, f.last_name AS faculty_last_name, f.first_name AS faculty_first_name, f.department AS faculty_department, f.salary AS faculty_salary ";
$from_clause = "FROM faculty AS f ";
$order_by_clause = "ORDER BY f.last_name ";
$where_clause = "WHERE f.department = '$department' and f.salary > $salary ";
...
<html>
<head>
<title>Faculty by Department</title>
<style type="text/css">
#table {
   width:100%;
